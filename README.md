...
> **注意**：当你在使用此项目时，遇到任何无法独自解决的问题请优先前往 [Issues](https://github.com/wanhebin/clash-for-linux/issues) 寻找解决方法。由于空闲时间有限，后续将不再对 Issues 中 “已经解答”、“已有解决方案” 的问题进行重复性的回答。
...
Clash Dashboard 访问地址：http://<ip>:50001/ui
...
通过浏览器访问 `start.sh` 执行成功后输出的地址，例如：http://192.168.0.1:50001/ui

- 登录管理界面

在`API Base URL`一栏中输入：http://\<ip\>:50001 ，在`Secret(optional)`一栏中输入启动成功后输出的 Secret。
